      ...
      <div className="flex items-center min-h-screen px-4 py-8">
        <div className='relative w-full max-w-lg px-4 mx-auto bg-white rounded-md shadow-lg'>
          ...
          <div className='max-w-sm mx-auto py-3 space-y-3 text-center'>
            ...
            <p className='text-[15px] text-gray-600'> This is the description for form component. 
              This is the description for form component</p>
              <form onSubmit={(e)=>{e.preventDefault()}}>
                ...
                <button onClick={()=>createItem()}
                        ...
                        rounded-lg ring-offset-2 ring-indigo-600 focus:ring-2'>Create Shipment</button>
              </form>
          </div>
        </div>
      </div>
